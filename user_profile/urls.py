...
urlpatterns = [
    ...
    path('api/profile/json/', views.show_json, name = 'show_profile-json'),
    path('api/profile/xml/', views.show_xml, name = 'show_profile_xml'),
    path('api/profile/xml/<int:id>/', views.show_xml_id, name = 'profile_xml_id'),
    path('api/profile/json/<int:id>/', views.show_json_id, name = 'profile_json_id'),
]